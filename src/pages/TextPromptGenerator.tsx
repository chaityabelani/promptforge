...
export default function TextPromptGenerator() {
  ...
  const handleGenerate = async () => {
    if (selectedTags.length === 0 && !description.trim()) return;
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={(selectedTags.length === 0 && !description.trim()) || isLoading}
              ...
              <AnimatePresence mode="wait">
                {error ? (
                  ...
                  >
                    ...
                    <p className="text-xs mt-2 opacity-50">Select tags or describe idea, then hit generate</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </div>
